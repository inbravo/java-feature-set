...
/**
 * The diamond operator, however, allows the right hand side of the assignment to be defined as a
 * true generic instance with the same type parameters as the left side... Without having to type
 * those parameters again. It allows you to keep the safety of generics with almost the same effort
 * as using the raw type.
 * 
 * @author amit.dixit
 *
 */
public final class DiamondOperatorTest {
