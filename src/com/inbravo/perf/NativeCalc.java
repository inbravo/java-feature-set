...
public final class NativeCalc {
	...
	public static void main(String[] args) {
		...
		System.out.println("Doubled Value = " + doubledValue + ", Time consumed in mathmatical operation = " + (endTime - startTime)
				+ " msec(s)");
		...
		System.out.println("Doubled Value = " + doubledValue + ", Time consumed in native operation = " + (endTime - startTime)
				+ " msec(s)");
	}
}
